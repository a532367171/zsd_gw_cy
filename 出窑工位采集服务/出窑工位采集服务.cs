                ...
                else
                {
                    ...
                    if (ii>3)
                    {
                        ...
                        try
                        {
                            ...
                            if (read_new_value_List[0] == "0" && read_new_value_List[5] == "0" && read_old_value_List[5] == "1")
                            {
                                strD = "INSERT INTO CmdGongWei (cGWid,cGWlineCode,cManufacture) VALUES ('01','01','" + Manufacture + "')";

                            }

                            if (read_new_value_List[1] == "0" && read_new_value_List[5] == "1" && read_old_value_List[5] == "0")
                            {
                                strD = "INSERT INTO CmdGongWei (cGWid,cGWlineCode,cManufacture) VALUES ('13','01','" + Manufacture + "')";
                            }

                            if (read_new_value_List[2] == "0" && read_new_value_List[5] == "1" && read_old_value_List[5] == "0")
                            {
                                strD = "INSERT INTO CmdGongWei (cGWid,cGWlineCode,cManufacture) VALUES ('13','02','" + Manufacture + "')";
                            }

                            if (read_new_value_List[3] == "1" && read_new_value_List[5] == "1" && read_old_value_List[5] == "0")
                            {
                                strD = "INSERT INTO CmdGongWei (cGWid,cGWlineCode,cManufacture) VALUES  ('13','03','" + Manufacture + "')";
                            }
