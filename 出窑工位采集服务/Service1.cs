...
namespace 出窑工位采集服务
{
    public partial class Service1 : ServiceBase
    {
        ...
        private void InitService()
        {
            ...
            base.ServiceName = "出窑工位采集服务";  //这个名字很重要，设置不一致会产生 1083 错误哦(在文章最后会说到这个问题)！
        }
        protected override void OnStart(string[] args)
        {
            ...
            出窑工位采集服务 x = new 出窑工位采集服务();

            //事件执行类 v = new 事件执行类(); /* 实例化对象 */

            //x.ChangeNum1 += new 出窑工位采集服务.NumManipulationHandler1(v.WriteLog1); /* 注册 */
